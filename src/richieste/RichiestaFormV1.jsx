...
const RichiestaForm = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-white to-gray-50 py-10 px-4">
      {loading && (
        <div className="fixed inset-0 bg-white bg-opacity-75 z-50 flex items-center justify-center">
          <ClipLoader size={50} color="#2563eb" />
        </div>
      )}
      <div className="max-w-xl mx-auto bg-white rounded-xl shadow-md px-8 py-10 border border-gray-200">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <button type="submit" disabled={loading} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-md transition">
            Invia la Richiesta
          </button>
        </form>
      </div>
