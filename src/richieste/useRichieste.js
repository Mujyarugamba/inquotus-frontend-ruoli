...
import { API_BASE } from '../config'; // ✅ usa config.test.js se sei in test
  ...
  return (
    <div style={{ maxWidth: '400px', margin: '2rem auto' }}>
      ...
      <form onSubmit={handleSubmit}>
        <input type="text" name="nome" placeholder="Nome completo" value={form.nome} onChange={handleChange} required /><br /><br />
        ...
        <select name="ruolo" value={form.ruolo} onChange={handleChange}>
          ...
          <option value="{ruolo === 'impresa' ? 'impresa' : 'professionista'}">Impresa</option>
