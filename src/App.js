...
import ConfermaInvio from './pages/ConfermaInvio';
...
function App() {
  const { utente, initializing } = useContext(AuthContext);
        ...
        <AuthProvider>
          ...
          <div style={{ minHeight: '80vh' }}>
            <Routes>
              ...
              {/* --- PRIVATE AREA --- */}
              <Route path="/committente" element={<PrivateRoute><Committente /></PrivateRoute>} />
              ...
              <Route path="/conferma-invio" element={<ConfermaInvio />} />
